...
const products = [
  {
    ...
    description:
      "Multi-parameter patient monitor for ICU and critical care settings. Features ECG, SpO2, NIBP, and temperature monitoring.",
    features: [
  ...
  },
  {
    ...
    description:
      "High-performance ventilator designed for adult and pediatric patients. Offers invasive and non-invasive ventilation modes.",
    features: [
  ...
  },
  {
    ...
    description:
      "State-of-the-art digital radiography system providing high-quality imaging with low radiation dose.",
    features: [
      "Max speed 15000 RPM",
      "Digital timer",
      "Safety lid lock",
  ...
  },
  {
    ...
    description:
      "3-part differential automated hematology analyzer for CBC testing.",
    features: [
      "60 samples/hour",
      '10.4" Touchscreen',
  ...
  },
  {
    ...
    description:
      "Vertical steam sterilizer for laboratory glassware and media.",
    features: [
...
function renderProducts(category) {
  ...
  if (filteredProducts.length === 0) {
    container.innerHTML =
      '<div class="col-span-full text-center py-10 text-text-secondary">No products found.</div>';
    return;
  }
  ...
  filteredProducts.forEach((product, index) => {
    ...
    card.className =
      "product-item bg-white rounded-2xl border border-border overflow-hidden hover:shadow-medium transition-all group cursor-pointer";
      ...
      product.name
            ...
            <div class="p-6">
                <div class="flex gap-2 mb-3">
                    <span class="text-xs font-bold px-2 py-1 bg-primary-50 text-primary-700 rounded uppercase tracking-wider">${product.category.replace(
                      "-",
                      " "
                    )}</span>
                </div>
...
function openProductModal(productId) {
  ...
  if (modalContactBtn)
    modalContactBtn.href = `contact_and_support.html?inquiry=${product.id}`;
...
window.performSearch = function (query) {
  ...
  if (filteredProducts.length === 0) {
    container.innerHTML =
      '<div class="col-span-full text-center py-10 text-text-secondary">No products found matching your search.</div>';
    return;
  }
